---
title: How can we engage more users with data design?
description: |-
  Summary

  For data to be designed for everyone, we need people who use that data to be part of the design process. This user-centred design UCD project analys...
date: '2025-08-07'
screenshots:
  items:
  - text: How to contribute for the data design process
    src: 01-how-to-contribute-for-the-data-design-process.png
    alt: A screenshot showing 3 pages of how to contribute to the data design process
  - text: The discreet user journey to get involved
    src: 02-the-discreet-user-journey-to-get-involved.png
    alt: A annotated screen showing a CTA within a page asking users to contribute
      to the data design process
  - text: How considerations used to link to github discussions
    src: 03-how-considerations-used-to-link-to-github-discussions.png
    alt: A screenshot of a consideration page, the github link is displayed by a number
...
__We didn’t post any information about our events on the website!__
...
See if you can get involved with the data design process on [our website](https://design.planning.data.gov.uk/get-involved-in-designing-data).

If you have any feedback [let us know](https://forms.office.com/pages/responsepage.aspx?id=EGg0v32c3kOociSi7zmVqFO3bTJ8VFpFodBlrVJHzGdUOVpGMEc1M0s1M0pDWktPVUxUWVoxNjRMTS4u&amp;route=shorturl)!
