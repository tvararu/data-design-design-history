---
title: Designing project pages
description: |-
  Discovering user needs

  The data design team had a clear need to document how projects a group of planning considerations move through the data design proces...
date: '2025-06-19'
screenshots:
  items:
  - text: Planning application submissions   original page
    src: 01-planning-application-submissions-original-page.png
    alt: A portion of the original planning application page with sprawling content
    caption: A portion of the page before a redesign, with more content being requested,
      this design wasn't efficient
  - text: Proposed user flow
    src: 02-proposed-user-flow.png
    alt: A user flow that now links the Project page to related considerations and
      datasets
    caption: External links worked well, but we needed to connect project pages better
      internally.
  - text: Translating existing content
    src: 03-translating-existing-content.png
    alt: A figma screenshot showing an analysis of current content and how it can
      fit the new template.
    caption: The beginning of translating the current planning applications page to
      fit the new template.
tags: []
---
